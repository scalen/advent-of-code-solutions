...
namespace _2024.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class Day6 : ControllerBase
    {
        private readonly ILogger<Day6> _logger;

        public Day6(ILogger<Day6> logger)
        {
            _logger = logger;
        }
        ...
        private static readonly char clear = '.';
        private static readonly char visited = 'X';
